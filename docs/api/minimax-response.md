...
parameter_groups:
  ...
  Observed: [max_completion_tokens, max_tokens, messages, n, stop, stream_options, thinking, user]
notes: 对照 docs/api/minimax-response.md（2026-06-16）。temperature/top_p 范围 (0,1]，非 OpenAI Responses 标准。 类型字段按该渠道官方 API 原文收录。 2026-07-08 联网对照官方文档已补录参数：max_completion_tokens, max_tokens, messages, n, stop, stream_options, thinking, user。
---
...
| `max_tokens` | `—` | no | — | — | 来源：实测（Noctua，2026-07-08）；联网对照官方文档（https://platform.minimax.io/docs/api-reference/text-chat-openai）检索到该参数，已补录。 |
| `messages` | `—` | no | — | — | 来源：实测（Noctua，2026-07-08）；联网对照官方文档（https://platform.minimax.io/docs/api-reference/text-chat-openai）检索到该参数，已补录。 |
...
| `thinking` | `—` | no | — | — | 来源：实测（Noctua，2026-07-08）；联网对照官方文档（https://platform.minimax.io/docs/api-reference/text-chat-openai）检索到该参数，已补录。 |
