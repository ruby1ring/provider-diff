window.LLM_ROSETTA_DATA = (() => {
  const parameterOrigins = window.PROVIDERX_RULES?.PARAMETER_ORIGINS || {
    ...
    reasoning_split: "minimax-private",
    "response_format.type=json_schema": "openai-standard",
    "response_format.type=json_object": "openai-standard",
    "messages[].content[].video_url": "openai-standard",
    "messages[].content[].audio_url": "openai-standard",
    "debug.echo_upstream_body": "openrouter-extension",
    "openrouter:web_fetch": "openrouter-extension",
    stop_server_tools_when: "openrouter-extension",
    cache_control: "openrouter-extension",
    image_config: "openrouter-extension",
    "provider.only": "openrouter-routing",
    "provider.ignore": "openrouter-routing",
  ...
  const channels = [
    ...
    withEndpoints({
      ...
      api_docs_url: "https://api-docs.deepseek.com/zh-cn/api/create-chat-completion",
      parameters: {
    ...
    withEndpoints({
      ...
      provider_id: "moonshot_messages",
      default_base_url: "https://api.moonshot.cn/anthropic/v1",
      default_model: "kimi-k2.6",
      api_docs_url: "https://platform.moonshot.cn/docs/api/chat"
    }),
    withEndpoints({
      ...
      parameters: {
        Sampling: ["temperature", "top_p", "stop", "n"],
        Length: ["max_tokens"],
        Output: ["response_format"],
        Tools: ["tools", "tool_choice"],
        Protocol: ["stream", "stream_options", "stream_options.include_usage"],
      ...
      provider_id: "zhipu_messages",
      default_base_url: "https://open.bigmodel.cn/api/anthropic/v1",
      default_model: "glm-5",
      api_docs_url: "https://open.bigmodel.cn/dev/api#glm-4"
    }),
    withEndpoints({
    ...
    withEndpoints({
      ...
      api_docs_url: "https://platform.minimax.io/docs/api-reference/text-chat-openai",
      parameters: {
    ...
    withEndpoints({
      ...
      api_docs_url: "https://api-docs.siliconflow.cn/docs/api/chat-completions-post",
      parameters: {
    ...
    withEndpoints({
      ...
      provider_id: "streamlake_messages",
      default_base_url: "https://wanqing.streamlakeapi.com/api/gateway/v1/endpoints",
      default_model: "ep-your-endpoint-id",
    ...
    withEndpoints({
      ...
      emoji: "🌐",
      logo: "/assets/logos/siliconflow-mark.svg",
      description: "SF Router 海外站（Silinex）",
      summary: "独立 API 逻辑 · 文档待补充",
    ...
    withEndpoints({
      ...
      emoji: "🇨🇳",
      logo: "/assets/logos/siliconflow-mark.svg",
      description: "SF Router 国内站（Silinex）",
      summary: "独立 API 逻辑 · 文档待补充",
  ...
  return {
    ...
    MOCK_PARAMETER_DESCRIPTIONS: window.PROVIDERX_RULES?.PARAMETER_DESCRIPTIONS || {},
